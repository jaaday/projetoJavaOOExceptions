public class Main {
	...
	public static void main(String[] args) {
		...
		*
		 * Conta c2 = new Conta("1",1000,cli2); ContaBonificada cb2 = new
		 * ContaBonificada("2",1000,cli3); Poupanca p2 = new
		 * Poupanca("3",1000,cli1); fachada.cadastrar(c2);
		 * fachada.cadastrar(cb2); fachada.cadastrar(p2);
		 * 
		 * 
		 * Conta c3= new Conta("4",1500,cli3); ContaBonificada cb3 = new
		 * ContaBonificada("5",1500,cli1); Poupanca p3 = new
		 * Poupanca("6",1500,cli2);
		 * 
		 * fachada.cadastrar(c3); fachada.cadastrar(cb3); fachada.cadastrar(p3);
		 * 
